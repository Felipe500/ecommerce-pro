    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('New', 'Criado'), ('Accepted', 'Aceito'), ('await_payment', 'Aguardando pagamento'), ('payment_confirmed', 'Pagamento Confirmado'), ('payment_error', 'Erro no Pagamento'), ('waiting_for_shipping', 'Aguardando Envio'), ('sent', 'Enviado'), ('Completed', 'Completo'), ('Cancelled', 'Cancelado')], default='New', max_length=21)),
